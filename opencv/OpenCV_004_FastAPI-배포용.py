 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "  \n",
    "- Jinja 템플릿\n",
    "    - 간단한 문법으로 html에서 {}(명령어를 적을때), {{}}(변수를 적을때 2개) 등의 규칙을 이용하여 python 프로그래밍이 가능\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "if __name__ == \"__main__\":\n",
    "    await asyncio.sleep(1)\n",
    "    uvicorn.run(app, host='192.168.70.49', port=9000, debug=False)"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "@app.get(\"/video_feed\")\n",
    "async def video_feed():\n",
    "    return StreamingResponse(get_frames(), media_type='multipart/x-mixed-replace; boundary=frame1')\n",
    "\n",
    "if __name__ == \"__main__\":\n",
    "    await asyncio.sleep(1)\n",
    "    uvicorn.run(app, host='192.168.70.49', port=9000, debug=False)"
